...
const notion_to_md_1 = __importDefault(__nccwpck_require__(143));
class NotionAdapter {
    notion;
    n2m;
    database_id;
    constructor(notion, database_id) {
        this.notion = notion;
        this.database_id = database_id || '';
        this.n2m = new notion_to_md_1.default({ notionClient: this.notion });
    }
    async fetchPagesReadyToPublish() {
        ...
        return results.map((res) => ({
            ...
            tags: res.properties.Tags.multi_select.map((s) => s.name),
    ...
    static instantiate({ api_key, database_id }) {
        return new NotionAdapter(new client_1.Client({ auth: api_key }), database_id);
    }
}
...
const md = __nccwpck_require__(251);
const { getBlockChildren } = __nccwpck_require__(69);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const notion_1 = __nccwpck_require__(93);
async function main() {
    console.log(notion_1.NotionAdapter.instantiate({ api_key: '', database_id: '' }));
}
